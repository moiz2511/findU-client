...
const UserDash = () => {
  return (
    <Flex width="1440px" height="1024px" background="#002045">
      ...
      >
        ...
        >
          ...
          >
            <Flex
              ...
              alignItems="center"
            >
              <Image src="cons.png" boxSize="100px" objectFit="fill" />
            </Flex>
            <Flex
              padding="8px"
              flexDirection="column"
          ...
          >
            <Flex
              ...
              alignItems="center"
            >
              <Image src="blockchains 1.png" boxSize="100px" objectFit="fill" />
            </Flex>
            <Flex
              padding="8px"
              flexDirection="column"
        ...
        <Flex>
          ...
          <Flex flexDirection="column" alignItems="center">
            ...
            <Flex margin={"auto"} mt={"200px"} mr={"30px"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="40"
